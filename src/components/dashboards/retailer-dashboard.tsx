                    ...
                    {recentOrders.slice(0, 5).map((order: any) => (
                      <div key={order.id} className="flex justify-between items-center p-6 hover:bg-[#FDFCF9] transition-colors group">
                        <div className="flex gap-4 items-center">
                          <div className="w-10 h-10 bg-[#F7F5F2] rounded-lg flex items-center justify-center font-mono text-xs font-bold text-[#1A1A1A]">#{order.order_number || order.id.slice(0, 6)}</div>
                          <div>
                            ...
                            <p className="text-[10px] text-[#6B6B6B] uppercase tracking-widest font-bold">{order.items?.length || 0} Manifest Items</p>
                          </div>
                        </div>
                        <div className="text-right">
                          ...
                          <Badge className={cn(
                            ...
                            order.payment_status === 'paid' ? "bg-emerald-50 text-emerald-700 border-emerald-100" : "bg-red-50 text-red-700 border-red-100"
                          )}>
